...
def new_round_body(round_id, email): 
    ...
    email_result = 'winning' if result == 'Win' else 'drawing' if result == 'Draw' else 'losing'
...
You picked <b>{}</b> who ended up <b>{}</b> their game - leaving you with a total score of <b>{}</b>.

Head over to the <a href="https://fpg-pick.streamlit.app">FPG Home Page</a> to see the details
